# Generated by Powerlevel10k configuration wizard on 2021-01-13 at 23:39 CST.
...
# disconnected, right frame, light-ornaments, compact, few icons, fluent,
...
() {
  ...
  #230 is white
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=175
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='(✿◠‿◠)❯'
